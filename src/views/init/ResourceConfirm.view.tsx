...
//
// ⚠️ **磁盘按真实构成说**（P21-8 §2）：预制镜像、运行时的 rootfs 缓存、每个 Task 一份
// 工作区副本，三项都在持续增长。只报总量会让人以为宽裕。
// ⚠️ **那句话按档生成，view 只负责渲染**（`lib/system/initWizardModel.ts#diskCompositionFor`）：
// 13GB 是 aio 档的镜像体积，boxlite 档铺开后约 1.3GB —— ⛔ 别在这里抄任何一个数字。
//
